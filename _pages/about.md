...
### Under Review
1. Qi Wang+\*, **Jindong Li+**, Shiqi Wang, Qianli Xing, Runliang Niu, He Kong, Rui Li, Guodong Long, Yi Chang\*, Chengqi Zhang. Towards Next-Generation LLM-based Recommender Systems: A Survey and Beyond.  [[GITHUB]](https://github.com/jindongli-Ai/Next-Generation-LLM-based-Recommender-Systems-Survey)
2. **Jindong Li**, Yixin Liu, Qianli Xing, Qi Wang\*, Yi Chang, Shirui Pan. No Fear of Representation Bias: Graph Contrastive Learning with Calibration and Fusion. *Neural Networks (NN, CORE A, CCF B)*  [[PDF]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4774833)  [[CODE]](https://github.com/jindongli-Ai/CANNON)
