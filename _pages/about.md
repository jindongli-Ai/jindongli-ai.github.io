...
2. Jindong Li, Yali Fu, Qi Wang. Large Language Models (LLMs) for Climate Change and Weather Forecasting: A Survey.
3. Jindong Li, Yali Fu, Qi Wang. A survey for Large Language Models (LLMs) Multi-Agent Collaboration.
...
5. **Jindong Li+**, Yali Fu+, Qi Wang\*. Graph Prompt Learning and Kolmogorov-Arnold Networks for Unsupervised Graph-Level Anomaly Detection.
