...
Hello! I am currently a Ph.D. student at AI Thrust, The Hong Kong University of Science and Technology ([HKUST-GZ](https://www.hkust-gz.edu.cn/)), under the supervision of Prof. [Menglin Yang](https://yangmenglinsite.github.io/) and Prof. [Hui Xiong](https://scholar.google.com/citations?hl=zh-CN&user=cVDF1tkAAAAJ) (Fellow of ACM, AAAS, AAAI and IEEE). 
<!--
...
- Vision-Language model (VLM) (Embodied Intelligence) ***<font color="#FFA500">(Seeking Collaborators)</font>***
...
- **Google Scholar**: [![Google Scholar](https://img.shields.io/badge/scholar-4385FE.svg?&style=plastic&logo=google-scholar&logoColor=white)](https://scholar.google.com/citations?user=w-ZGDjMAAAAJ&hl=zh-CN) <font color="#FFA500">487</font>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    ...
    <a href="https://iclr.cc/virtual/2026/poster/10009621">ICLR</a> |
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [8] <b style="color: #0A1624;">SRTJ: Self-Evolving Rule-Driven Training-Free LLM Jailbreaking</b><br>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [10] <b style="color: #0A1624;">Beyond Retraining: Training-Free Unknown Class Filtering for Source-Free Open Set Domain Adaptation of Vision–Language Models
</b><br>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [12] <b style="color: #0A1624;">HC-GLAD: Dual Hyperbolic Contrastive Learning for Unsupervised Graph-Level Anomaly Detection</b><br>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [13] <b style="color: #0A1624;">HyGROVE: Generative View Learning with Hypergraph Transformation for Unsupervised Graph-Level Anomaly Detection</b><br>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [14] <b style="color: #0A1624;">GLADMamba: Unsupervised Graph-Level Anomaly Detection Powered by Selective State Space Model</b><br>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [15] <b style="color: #0A1624;">CVTGAD: Simplified Transformer with Cross-View Attention for Unsupervised Graph-Level Anomaly Detection</b><br>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  <img src="/images/2024_arXiv_LLM-RecSys-Survey.png" alt="LLM-RecSys-Survey" width="250">
  <div>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [6] <b style="color: #0A1624;">StorySpark: Module-wise Evolutionary Search for Story Premise Generation</b><br>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [7] <b style="color: #0A1624;">HyBIRD: Hyperbolic Bridge Retrieval and Diagnosis for Methodology Inspiration Retrieval</b><br>
...
<p align="center"><b><i><font color="#FFA500">(c) Graph Learning</font></i></b></p>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [10] <b style="color: #0A1624;">No Fear of Representation Bias: Graph Contrastive Learning with Calibration and Fusion</b><br>
...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    [11] <b style="color: #0A1624;">FANFOLD: Graph Normalization Flows-driven Asymmetric Network for Unsupervised Graph-Level Anomaly Detection</b><br>
...
<p align="center"><b><i><font color="#FFA500">(d) 3D Point Cloud</font></i></b></p>
...
- **Programming Languages**: Python. Also experienced with C++, Java, C, Go, MySQL.
