...
9. Yongguang Li, **Jindong Li**, Qi Wang*, Qianli Xing, Runliang Niu, Shengsheng Wang, Menglin Yang. CLIP for Source-Free Open-Set Domain Adaptation. [[PDF]]() [[CODE]]()
10. Yali Fu+, **Jindong Li+**, Qi Wang\*, Qianli Xing. GLADMamba: Unsupervised Graph-Level Anomaly Detection Powered by Selective State Space Model. [[PDF]](https://arxiv.org/abs/2503.17903) [[CODE]](https://github.com/Yali-F/GLADMamba)


### In Preparation
1. **Jindong Li**, Yongguang Li, Yali Fu, Jiahong Liu, Yixin Liu, Qi Wang, Menglin Yang\*, Irwin King. CLIP-Powered Domain Generalization and Domain Adaptation: A Comprehensive Survey. [[GITHUB]](https://github.com/jindongli-Ai/Survey_of_CLIP-Powered_Domain_Generalization_and_Adaptation)
2. **Jindong Li+**, Yali Fu+, Mengling Yang*. Bridging Multiple Modality to Large Language Models: A Survey on Discrete Tokenization. [[GITHUB]]()
